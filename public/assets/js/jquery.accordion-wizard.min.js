! function(a, t, e, s) { "use strict"; var n = "accWizard",
        i = { start: 1, mode: "wizard", enableScrolling: !0, scrollPadding: 5, autoButtons: !0, autoButtonsNextClass: null, autoButtonsPrevClass: null, autoButtonsShowSubmit: !0, autoButtonsSubmitText: "Submit", autoButtonsEditSubmitText: "Save", stepNumbers: !0, stepNumberClass: "", beforeNextStep: function(t) { return !0 }, onSubmit: function(t) { return !0 } };

    function c(t, e) { this.element = t, this.settings = a.extend({}, i, e), this._defaults = i, this._name = n, this.init() }
    a.extend(c.prototype, { init: function() { var i = this;
            this.$steps = a("[data-acc-step]"), this.stepHeight = a("[data-acc-step]").eq(0).outerHeight(), this.settings.stepNumbers && this.$steps.each(function(t, e) { a("[data-acc-title]", e).prepend('<span class="acc-step-number ' + i.settings.stepNumberClass + '">' + (t + 1) + "</span> ") }), this.settings.autoButtons && this.$steps.each(function(t, e) { var s = a("[data-acc-content]", e); if (0 < t && s.append('<a href="#" class="' + i.settings.autoButtonsPrevClass + '" data-acc-btn-prev>Back</a>'), t < i.$steps.length - 1) s.append('<a href="#" class="' + i.settings.autoButtonsNextClass + '" data-acc-btn-next>Next</a>');
                else if (i.settings.autoButtonsShowSubmit) { var n = "wizard" == i.settings.mode ? i.settings.autoButtonsSubmitText : i.settings.autoButtonsEditSubmitText;
